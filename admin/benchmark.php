...
<h1 class="mb-3"><i class="fa-solid fa-gear"></i> System Settings & Benchmarks</h1>
...
<div class="card">
    ...
    <form method="POST">
        <h3 class="mt-3"><i class="fa-solid fa-bolt"></i> Electricity Settings</h3>
        ...
        <h3 class="mt-3"><i class="fa-solid fa-clipboard-question"></i> Quiz Settings</h3>
        ...
        <h3 class="mt-3"><i class="fa-solid fa-fire"></i> Streak Bonuses</h3>
...
<div class="card mt-3">
    <h2 class="card-header"><i class="fa-solid fa-lightbulb"></i> Tips</h2>
