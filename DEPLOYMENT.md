...
- [ ] Log electricity usage (/student/electricity.php)
- [ ] Take a quiz (/community/quiz.php)
- [ ] View and submit challenge (/community/challenges.php)
- [ ] Check leaderboard (/community/leaderboard.php)
- [ ] Browse rewards shop (/community/rewards.php)
- [ ] View achievements (/student/achievements.php)
- [ ] Check virtual tree (/student/tree.php)
- [ ] View points history (/community/points.php)

### ✅ Staff Features Test
- [ ] Login as staff1@green.edu
- [ ] View staff dashboard
- [ ] Post eco-tip (/community/eco_tips.php)
- [ ] View department statistics
- [ ] Participate in challenge (/community/challenges.php)
