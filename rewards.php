...
<h1 class="mb-3">🎁 Rewards Shop</h1>

<div class="alert alert-info">
    <strong>Your Points:</strong> ⭐ <?php echo number_format($user['points_total']); ?> points
</div>
...
<div class="card-grid">
    <?php foreach ($rewards as $reward): ?>
        ...
        <div class="card">
            ...
            <h3 class="mt-2"><?php echo clean($reward['name']); ?></h3>
            <p><?php echo clean($reward['description']); ?></p>
            <p><strong>💰 Cost:</strong> <?php echo number_format($reward['points_cost']); ?> points</p>
            <p><strong>📦 Stock:</strong> <?php echo $reward['stock_qty']; ?> left</p>
