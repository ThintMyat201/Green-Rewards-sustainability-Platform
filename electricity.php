...
<h1 class="mb-3">⚡ Electricity Usage Logger</h1>
...
<div class="card-grid">
    <div class="card">
        ...
        <div class="alert alert-info">
            <strong>🎯 Current Benchmark:</strong> <?php echo $benchmark; ?> kWh/month<br>
            <strong>💰 Reward:</strong> <?php echo $pointsPerKwh; ?> points per kWh saved
        </div>
