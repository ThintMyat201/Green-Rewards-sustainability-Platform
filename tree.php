...
<h1 class="mb-3 text-center">🌳 My Virtual Tree Pet</h1>
...
<div class="card mt-3">
    ...
    <?php else: ?>
        <div class="alert alert-success mt-3">
            <strong>🎉 Congratulations!</strong> Your tree has reached maximum growth!
        </div>
    <?php endif; ?>
</div>
...
<div class="text-center mt-3">
    ...
    <a href="/challenges.php" class="btn btn-success">Earn More Points</a>
</div>
